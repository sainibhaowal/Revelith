...
[private vulnerability reporting](https://github.com/sainibhaowal/Revelith/security/advisories/new)
...
- Every `shell.openExternal` call goes through a single shared gate
  (`@revelith/electron-utils` → `safeExternalUrl`) that parses the URL and
