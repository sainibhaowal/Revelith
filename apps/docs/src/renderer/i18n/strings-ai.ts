...
export const aiStrings = defineStrings({
  zh: {
    ...
    aiGskLoginBtn: '登录 ReveLith',
    aiUndelivered: '未送达,本条不会生效',
    aiPanelTitle: 'ReveLith AI',
    ...
    aiCreditsExhausted: 'ReveLith 积分已用完，请前往 genspark.ai/pricing 充值后重试',
  ...
  en: {
    ...
    aiGskLoginBtn: 'Sign in to ReveLith',
    ...
    aiCreditsExhausted:
      'Your ReveLith credits have run out. Visit genspark.ai/pricing to top up, then try again',
  ...
  ja: {
    ...
    aiCreditsExhausted:
      'ReveLithクレジットを使い切りました。genspark.ai/pricing でチャージしてから再試行してください',
  ...
  ko: {
    ...
    aiCreditsExhausted:
      'ReveLith 크레딧을 모두 사용했습니다. genspark.ai/pricing에서 충전한 후 다시 시도해 주세요',
  ...
  fr: {
    ...
    aiGskLoginBtn: 'Se connecter à ReveLith',
    ...
    aiCreditsExhausted:
      'Vos crédits ReveLith sont épuisés. Rechargez sur genspark.ai/pricing puis réessayez',
  ...
  de: {
    ...
    aiGskLoginBtn: 'Bei ReveLith anmelden',
    ...
    aiCreditsExhausted:
      'Deine ReveLith-Credits sind aufgebraucht. Lade unter genspark.ai/pricing auf und versuche es erneut',
  ...
  es: {
    ...
    aiGskLoginBtn: 'Iniciar sesión en ReveLith',
    ...
    aiCreditsExhausted:
      'Tus créditos de ReveLith se han agotado. Recarga en genspark.ai/pricing e inténtalo de nuevo',
  ...
  th: {
    ...
    aiGskLoginBtn: 'ลงชื่อเข้าใช้ ReveLith',
    ...
    aiCreditsExhausted:
      'เครดิต ReveLith ของคุณหมดแล้ว โปรดเติมเครดิตที่ genspark.ai/pricing แล้วลองใหม่',
  ...
  id: {
    ...
    aiGskLoginBtn: 'Masuk ke ReveLith',
    ...
    aiCreditsExhausted:
      'Kredit ReveLith Anda telah habis. Isi ulang di genspark.ai/pricing lalu coba lagi',
  ...
  ru: {
    ...
    aiGskLoginBtn: 'Войти в ReveLith',
    ...
    aiCreditsExhausted:
      'Кредиты ReveLith исчерпаны. Пополните баланс на genspark.ai/pricing и повторите попытку',
  ...
  ar: {
    ...
    aiGskLoginBtn: 'تسجيل الدخول إلى ReveLith',
    ...
    aiCreditsExhausted:
      'نفدت أرصدة ReveLith لديك. يرجى إعادة الشحن عبر genspark.ai/pricing ثم المحاولة مجددًا',
  ...
  pt: {
    ...
    aiGskLoginBtn: 'Entrar no ReveLith',
    ...
    aiCreditsExhausted:
      'Seus créditos ReveLith acabaram. Recarregue em genspark.ai/pricing e tente novamente',
  ...
  it: {
    ...
    aiGskLoginBtn: 'Accedi a ReveLith',
    ...
    aiCreditsExhausted:
      'I tuoi crediti ReveLith sono esauriti. Ricarica su genspark.ai/pricing e riprova',
  ...
  pl: {
    ...
    aiGskLoginBtn: 'Zaloguj się do ReveLith',
    ...
    aiCreditsExhausted:
      'Twoje kredyty ReveLith wyczerpały się. Doładuj konto na genspark.ai/pricing i spróbuj ponownie',
  ...
  nl: {
    ...
    aiGskLoginBtn: 'Aanmelden bij ReveLith',
    ...
    aiCreditsExhausted:
      'Je ReveLith-credits zijn op. Waardeer op via genspark.ai/pricing en probeer het opnieuw',
  ...
  ms: {
    ...
    aiGskLoginBtn: 'Log masuk ke ReveLith',
    ...
    aiCreditsExhausted:
      'Kredit ReveLith anda telah habis. Tambah nilai di genspark.ai/pricing dan cuba lagi',
    aiSumReadAttachment: 'Baca lampiran',
  ...
  he: {
    ...
    aiGskLoginBtn: 'התחבר ל-ReveLith',
    ...
    aiCreditsExhausted: 'קרדיטי ReveLith שלך אזלו. טען מחדש ב-genspark.ai/pricing ונסה שוב',
  ...
  hi: {
    ...
    aiGskLoginBtn: 'ReveLith में साइन इन करें',
    ...
    aiCreditsExhausted:
      'आपके ReveLith क्रेडिट समाप्त हो गए हैं। genspark.ai/pricing पर रिचार्ज करें और फिर से प्रयास करें',
  ...
  'zh-TW': {
    ...
    aiCreditsExhausted: 'ReveLith 點數已用完，請前往 genspark.ai/pricing 儲值後重試',
