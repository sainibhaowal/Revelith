...
const DOWNLOAD_PAGE_URL = 'https://github.com/sainibhaowal/Revelith/releases/latest'
...
export function initAutoUpdater(
  ...
  if (!app.isPackaged && process.env.REVELITH_FAKE_UPDATE) {
    initFakeUpdate(getWindow, process.env.REVELITH_FAKE_UPDATE)
    return
  }
