  ...
  return (
    <div className="account-entry">
      ...
      <button
        ...
        aria-label="Settings"
      >
        <span className="account-avatar-cog" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', width: '28px', height: '28px', color: 'var(--text-primary, currentColor)' }}>
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            {/* Precision vector cog / settings gear */}
      ...
      <div className="quick-cards">
        ...
        <button className="quick-card quick-card-browse" onClick={() => void window.aiOffice.browse()}>
          ...
          <span className="quick-text">
            ...
            <span className="quick-sub">.docx · .xlsx · .pptx · .pdf · .md</span>
          </span>
        </button>
      </div>
    )
