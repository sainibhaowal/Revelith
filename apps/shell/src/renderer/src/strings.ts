...
export const strings = {
  zh: {
    ...
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'ReveLith Projects',
    cloudSubtitle: '在网页端用 ReveLith AI 创建的项目。编辑在浏览器中继续::点击任意项目即可打开。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '刷新',
    cloudLoginHint: '登录 ReveLith 账号，查看你在网页端创建的项目。',
    cloudEmpty: '还没有网页端项目。',
    ...
    noContent: '（无内容）',
    // Account
    accountReveLith: 'ReveLith 账号',
    account: '账号',
    login: '登录',
    loginReveLith: '登录 ReveLith 账号',
    loggedIn: '已登录',
    loggedInReveLith: '已登录 ReveLith',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 ReveLith,请检查网络或代理设置',
    ...
    onbTitle1: '欢迎使用 ReveLith',
    onbSubtitle1: '第一个开源的 AI 原生 Office 套件',
    onbBody1: '创建文档、制作表格、生成演示、审阅 PDF。AI 深度融入每个环节。',
    onbTitle2: '这只是一个开始',
    onbBody2: 'ReveLith 目前处于 alpha 阶段。欢迎加入 ReveLith 社区，分享反馈，一起塑造它的未来。',
    onbCredits: '活跃贡献者可获得 **1,000+ ReveLith 积分**',
    onbJoinCommunity: '加入社区',
    onbSkip: '跳过',
    onbNext: '下一步',
    onbStart: '开始使用',
    ...
    onbNote3: 'AI 功能可能消耗 ReveLith 积分。',
    onbBack: '上一步',
  },
  en: {
    navRecent: 'Recent',
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Projects created on the web with ReveLith AI. Editing continues in your browser : click any project to open it.',
    ...
    cloudLoginHint: 'Sign in to your ReveLith account to see projects you created on the web.',
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountReveLith: 'ReveLith Account',
    account: 'Account',
    login: 'Sign in',
    loginReveLith: 'Sign in with ReveLith',
    loggedIn: 'Signed in',
    loggedInReveLith: 'Signed in to ReveLith',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach ReveLith : check your network or proxy settings',
    ...
    onbBody2:
      'ReveLith is actively evolving. Share your feedback, report issues, and help shape what comes next.',
    onbCredits: 'Community driven and open-source',
    onbJoinCommunity: 'Learn More',
    onbSkip: 'Skip',
    onbNext: 'Next',
    ...
    onbNote3: '100% private, local-first document processing.',
    onbBack: 'Back',
  },
  ja: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Web で ReveLith AI を使って作成したプロジェクト。編集はブラウザで続行します。クリックで開きます。',
    ...
    cloudRefresh: '更新',
    cloudLoginHint:
      'ReveLith アカウントにサインインすると、Web で作成したプロジェクトを表示できます。',
    ...
    noContent: '（内容なし）',
    // Account
    accountReveLith: 'ReveLith アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginReveLith: 'ReveLith アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInReveLith: 'ReveLith にサインイン済み',
    waitingLogin:
    ...
    loginCopied: 'コピーしました',
    loginNetworkError:
      'ReveLith に接続できません。ネットワークまたはプロキシ設定を確認してください',
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'ReveLith へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'ReveLith はまだアルファ版です。ReveLith コミュニティに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ ReveLith クレジット**',
    onbJoinCommunity: 'コミュニティに参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は ReveLith クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'ReveLith AI로 웹에서 만든 프로젝트입니다. 편집은 브라우저에서 계속됩니다. 프로젝트를 클릭하면 열립니다.',
    ...
    cloudRefresh: '새로고침',
    cloudLoginHint: 'ReveLith 계정에 로그인하면 웹에서 만든 프로젝트를 볼 수 있습니다.',
    ...
    noContent: '(내용 없음)',
    // Account
    accountReveLith: 'ReveLith 계정',
    account: '계정',
    login: '로그인',
    loginReveLith: 'ReveLith 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInReveLith: 'ReveLith에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'ReveLith에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'ReveLith에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'ReveLith는 아직 알파 단계입니다. ReveLith 커뮤니티에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ ReveLith 크레딧**',
    onbJoinCommunity: '커뮤니티 참여',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 기능은 ReveLith 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      "Projets créés sur le web avec ReveLith AI. L'édition continue dans votre navigateur : cliquez sur un projet pour l'ouvrir.",
    ...
    cloudLoginHint:
      'Connectez-vous à votre compte ReveLith pour voir les projets créés sur le web.',
    ...
    noContent: '(vide)',
    // Account
    accountReveLith: 'Compte ReveLith',
    account: 'Compte',
    login: 'Se connecter',
    loginReveLith: 'Se connecter avec ReveLith',
    loggedIn: 'Connecté',
    loggedInReveLith: 'Connecté à ReveLith',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre ReveLith : vérifiez votre réseau ou vos paramètres de proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenue dans ReveLith',
    ...
    onbBody2:
      'ReveLith est encore en alpha. Rejoignez la communauté ReveLith pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits ReveLith**',
    onbJoinCommunity: 'Rejoindre la communauté',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits ReveLith.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Mit ReveLith AI im Web erstellte Projekte. Die Bearbeitung läuft im Browser weiter – klicken Sie auf ein Projekt, um es zu öffnen.',
    ...
    cloudLoginHint:
      'Melden Sie sich bei Ihrem ReveLith-Konto an, um Ihre im Web erstellten Projekte zu sehen.',
    ...
    noContent: '(leer)',
    // Account
    accountReveLith: 'ReveLith-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginReveLith: 'Mit ReveLith anmelden',
    loggedIn: 'Angemeldet',
    loggedInReveLith: 'Bei ReveLith angemeldet',
    waitingLogin:
    ...
    loginCopied: 'Kopiert',
    loginNetworkError:
      'ReveLith ist nicht erreichbar : prüfen Sie Netzwerk- oder Proxy-Einstellungen',
    ...
    newTab: 'Neuer Tab',
    // First-run onboarding
    onbTitle1: 'Willkommen bei ReveLith',
    ...
    onbBody2:
      'ReveLith ist noch in der Alpha-Phase. Treten Sie dem ReveLith-Community bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ ReveLith-Guthaben**',
    ...
    onbNote3: 'KI-Funktionen können ReveLith-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Proyectos creados en la web con ReveLith AI. La edición continúa en tu navegador: haz clic en un proyecto para abrirlo.',
    ...
    cloudLoginHint:
      'Inicia sesión en tu cuenta de ReveLith para ver los proyectos creados en la web.',
    ...
    noContent: '(vacío)',
    // Account
    accountReveLith: 'Cuenta de ReveLith',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginReveLith: 'Iniciar sesión con ReveLith',
    loggedIn: 'Sesión iniciada',
    loggedInReveLith: 'Sesión iniciada en ReveLith',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con ReveLith : compruebe su red o la configuración del proxy',
    ...
    // First-run onboarding
    onbTitle1: 'Bienvenido a ReveLith',
    ...
    onbBody2:
      'ReveLith aún está en alfa. Únete al comunidad ReveLith para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de ReveLith**',
    onbJoinCommunity: 'Unirse a la comunidad',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de ReveLith.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'โปรเจกต์ที่สร้างบนเว็บด้วย ReveLith AI แก้ไขต่อได้ในเบราว์เซอร์ : คลิกโปรเจกต์เพื่อเปิด',
    ...
    cloudRefresh: 'รีเฟรช',
    cloudLoginHint: 'ลงชื่อเข้าใช้บัญชี ReveLith เพื่อดูโปรเจกต์ที่คุณสร้างบนเว็บ',
    ...
    // Account
    accountReveLith: 'บัญชี ReveLith',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginReveLith: 'ลงชื่อเข้าใช้ด้วย ReveLith',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInReveLith: 'ลงชื่อเข้าใช้ ReveLith แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ ReveLith ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ ReveLith',
    ...
    onbBody2:
      'ReveLith ยังอยู่ในช่วงอัลฟ่า เข้าร่วมชุมชน ReveLith เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต ReveLith กว่า 1,000**',
    onbJoinCommunity: 'เข้าร่วมชุมชน',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต ReveLith',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Proyek yang dibuat di web dengan ReveLith AI. Pengeditan berlanjut di browser : klik proyek untuk membukanya.',
    ...
    cloudLoginHint: 'Masuk ke akun ReveLith untuk melihat proyek yang Anda buat di web.',
    ...
    noContent: '(kosong)',
    // Account
    accountReveLith: 'Akun ReveLith',
    account: 'Akun',
    login: 'Masuk',
    loginReveLith: 'Masuk dengan ReveLith',
    loggedIn: 'Sudah masuk',
    loggedInReveLith: 'Sudah masuk ke ReveLith',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke ReveLith : periksa jaringan atau pengaturan proxy Anda',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di ReveLith',
    ...
    onbBody2:
      'ReveLith masih dalam tahap alpha. Gabung komunitas ReveLith untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit ReveLith**',
    onbJoinCommunity: 'Gabung Komunitas',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit ReveLith.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Проекты, созданные в вебе с ReveLith AI. Редактирование продолжается в браузере : нажмите на проект, чтобы открыть его.',
    ...
    cloudLoginHint: 'Войдите в аккаунт ReveLith, чтобы увидеть проекты, созданные в вебе.',
    ...
    noContent: '(пусто)',
    // Account
    accountReveLith: 'Учётная запись ReveLith',
    account: 'Учётная запись',
    login: 'Войти',
    loginReveLith: 'Войти через ReveLith',
    loggedIn: 'Вход выполнен',
    loggedInReveLith: 'Выполнен вход в ReveLith',
    ...
    loginNetworkError: 'Не удаётся подключиться к ReveLith : проверьте сеть или настройки прокси',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в ReveLith',
    ...
    onbBody2:
      'ReveLith пока в альфа-версии. Присоединяйтесь к сообществу ReveLith, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов ReveLith**',
    onbJoinCommunity: 'Присоединиться к сообществу',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты ReveLith.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'مشاريع أُنشئت على الويب باستخدام ReveLith AI. يستمر التحرير في المتصفح : انقر على أي مشروع لفتحه.',
    ...
    cloudRefresh: 'تحديث',
    cloudLoginHint: 'سجّل الدخول إلى حساب ReveLith لعرض المشاريع التي أنشأتها على الويب.',
    ...
    noContent: '(فارغ)',
    // Account
    accountReveLith: 'حساب ReveLith',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginReveLith: 'تسجيل الدخول باستخدام ReveLith',
    loggedIn: 'تم تسجيل الدخول',
    loggedInReveLith: 'تم تسجيل الدخول إلى ReveLith',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ ReveLith : تحقق من الشبكة أو إعدادات الوكيل',
    ...
    // First-run onboarding
    onbTitle1: 'مرحبًا بك في ReveLith',
    ...
    onbBody2:
      'لا يزال ReveLith في مرحلة ألفا. انضم إلى مجتمع ReveLith لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة ReveLith**',
    onbJoinCommunity: 'الانضمام إلى المجتمع',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة ReveLith.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Projetos criados na web com o ReveLith AI. A edição continua no navegador : clique em um projeto para abri-lo.',
    ...
    cloudLoginHint: 'Entre na sua conta ReveLith para ver os projetos criados na web.',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountReveLith: 'Conta ReveLith',
    account: 'Conta',
    login: 'Entrar',
    loginReveLith: 'Entrar com a ReveLith',
    loggedIn: 'Conectado',
    loggedInReveLith: 'Conectado à ReveLith',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao ReveLith : verifique sua rede ou as configurações de proxy',
    ...
    newTab: 'Nova guia',
    // First-run onboarding
    onbTitle1: 'Bem-vindo ao ReveLith',
    ...
    onbBody2:
      'O ReveLith ainda está em alfa. Entre no comunidade ReveLith para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos ReveLith**',
    onbJoinCommunity: 'Entrar na comunidade',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos ReveLith.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Progetti creati sul web con ReveLith AI. La modifica continua nel browser: fai clic su un progetto per aprirlo.',
    ...
    cloudLoginHint: 'Accedi al tuo account ReveLith per vedere i progetti creati sul web.',
    ...
    noContent: '(vuoto)',
    accountReveLith: 'Account ReveLith',
    account: 'Account',
    login: 'Accedi',
    loginReveLith: 'Accedi con ReveLith',
    loggedIn: 'Accesso effettuato',
    loggedInReveLith: 'Accesso effettuato a ReveLith',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere ReveLith : controlla la rete o le impostazioni del proxy',
    ...
    newTab: 'Nuova scheda',
    // First-run onboarding
    onbTitle1: 'Benvenuto in ReveLith',
    ...
    onbBody2:
      'ReveLith è ancora in alpha. Unisciti alla community ReveLith per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti ReveLith**',
    onbJoinCommunity: 'Unisciti alla community',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti ReveLith.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Projekty utworzone w sieci za pomocą ReveLith AI. Edycja jest kontynuowana w przeglądarce : kliknij projekt, aby go otworzyć.',
    ...
    cloudLoginHint: 'Zaloguj się na konto ReveLith, aby zobaczyć projekty utworzone w sieci.',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountReveLith: 'Konto ReveLith',
    account: 'Konto',
    login: 'Zaloguj się',
    loginReveLith: 'Zaloguj się przez ReveLith',
    loggedIn: 'Zalogowano',
    loggedInReveLith: 'Zalogowano do ReveLith',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z ReveLith : sprawdź sieć lub ustawienia proxy',
    ...
    onbBody2:
      'ReveLith jest wciąż w fazie alfa. Dołącz do społeczności ReveLith, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów ReveLith**',
    onbJoinCommunity: 'Dołącz do społeczności',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty ReveLith.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Projecten gemaakt op het web met ReveLith AI. Bewerken gaat verder in je browser : klik op een project om het te openen.',
    ...
    cloudLoginHint:
      'Log in op je ReveLith-account om projecten te zien die je op het web hebt gemaakt.',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginReveLith: 'Inloggen met ReveLith',
    loggedIn: 'Ingelogd',
    loggedInReveLith: 'Ingelogd bij ReveLith',
    ...
    loginNetworkError: 'Kan ReveLith niet bereiken : controleer uw netwerk of proxyinstellingen',
    ...
    onbBody2:
      'ReveLith is nog in alfa. Doe mee aan de ReveLith-community om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ ReveLith-credits**',
    onbJoinCommunity: 'Lid worden',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies kunnen ReveLith-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'Projek yang dicipta di web dengan ReveLith AI. Penyuntingan diteruskan dalam pelayar : klik projek untuk membukanya.',
    ...
    cloudLoginHint: 'Log masuk ke akaun ReveLith untuk melihat projek yang anda cipta di web.',
    ...
    noContent: '(kosong)',
    accountReveLith: 'Akaun ReveLith',
    account: 'Akaun',
    login: 'Log masuk',
    loginReveLith: 'Log masuk dengan ReveLith',
    loggedIn: 'Telah log masuk',
    loggedInReveLith: 'Telah log masuk ke ReveLith',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat menyambung ke ReveLith : semak rangkaian atau tetapan proksi anda',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke ReveLith',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'ReveLith masih dalam peringkat alfa. Sertai komuniti ReveLith untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit ReveLith**',
    onbJoinCommunity: 'Sertai Komuniti',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit ReveLith.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'פרויקטים שנוצרו באינטרנט עם ReveLith AI. העריכה נמשכת בדפדפן : לחצו על פרויקט כדי לפתוח אותו.',
    ...
    cloudRefresh: 'רענון',
    cloudLoginHint: 'התחברו לחשבון ReveLith כדי לראות פרויקטים שיצרתם באתר.',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountReveLith: 'חשבון ReveLith',
    account: 'חשבון',
    login: 'התחברות',
    loginReveLith: 'התחברות עם ReveLith',
    loggedIn: 'מחובר',
    loggedInReveLith: 'מחובר ל-ReveLith',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-ReveLith : בדקו את הרשת או את הגדרות ה-proxy',
    ...
    // First-run onboarding
    onbTitle1: 'ברוכים הבאים ל-ReveLith',
    ...
    onbBody2:
      'ReveLith עדיין בגרסת אלפא. הצטרפו לקהילת ReveLith כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות ReveLith**',
    onbJoinCommunity: 'הצטרפו לקהילה',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של ReveLith.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    navCloud: 'ReveLith Projects',
    cloudSubtitle:
      'ReveLith AI के साथ वेब पर बनाए गए प्रोजेक्ट। संपादन ब्राउज़र में जारी रहता है : खोलने के लिए किसी प्रोजेक्ट पर क्लिक करें।',
    ...
    cloudLoginHint: 'वेब पर बनाए गए प्रोजेक्ट देखने के लिए अपने ReveLith खाते में साइन इन करें।',
    ...
    noContent: '(खाली)',
    accountReveLith: 'ReveLith खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginReveLith: 'ReveLith से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInReveLith: 'ReveLith में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'ReveLith से कनेक्ट नहीं हो सका : नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'ReveLith में आपका स्वागत है',
    ...
    onbBody2:
      'ReveLith अभी अल्फ़ा में है। ReveLith कम्युनिटी से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ ReveLith क्रेडिट**',
    onbJoinCommunity: 'कम्युनिटी से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ ReveLith क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    navStarred: '收藏',
    navCloud: 'ReveLith Projects',
    cloudSubtitle: '在網頁端用 ReveLith AI 建立的專案。編輯在瀏覽器中繼續::點擊任意專案即可開啟。',
    ...
    cloudSortOldest: '最早',
    cloudRefresh: '重新整理',
    cloudLoginHint: '登入 ReveLith 帳號，查看你在網頁端建立的專案。',
    cloudEmpty: '還沒有網頁端專案。',
    ...
    untitled: '未命名',
    noContent: '（無內容）',
    accountReveLith: 'ReveLith 帳號',
    account: '帳號',
    login: '登入',
    loginReveLith: '登入 ReveLith 帳號',
    loggedIn: '已登入',
    loggedInReveLith: '已登入 ReveLith',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 ReveLith，請檢查網路或代理設定',
    ...
    newTab: '新分頁',
    // First-run onboarding
    onbTitle1: '歡迎使用 ReveLith',
    onbSubtitle1: '第一個開源的 AI 原生 Office 套件',
    onbBody1: '建立文件、製作試算表、產生簡報、審閱 PDF。AI 深度融入每個環節。',
    onbTitle2: '這只是一個開始',
    onbBody2: 'ReveLith 目前仍在 alpha 階段。歡迎加入 ReveLith 社区，分享回饋，一起打造它的未來。',
    onbCredits: '活躍貢獻者可獲得 **1,000+ ReveLith 點數**',
    onbJoinCommunity: '加入社区',
    onbSkip: '略過',
    onbNext: '下一步',
    onbStart: '開始使用',
    ...
    onbNote3: 'AI 功能可能消耗 ReveLith 點數。',
    onbBack: '上一步',
  },
} as const
