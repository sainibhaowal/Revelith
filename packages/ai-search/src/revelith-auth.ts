 ...
 * app_type=revelith) minting a gsk API key named "revelith" : the key_name
...
/**
 * Starts the Revelith device-code login, cancelling a previous in-flight one
...
/**
 * Signs out of Revelith only: best-effort server-side revoke of the
 * revelith key, then local removal. The shared gsk CLI login
