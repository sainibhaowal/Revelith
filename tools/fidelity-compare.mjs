 ...
 * Our side: playwright drives the packaged Revelith Slides (Electron) with zoom locked at 100%,
 ...
 * Prereq: npm run build -w @revelith/slides; brew: libreoffice + poppler (pdftoppm).
 */
...
/**
 * Opens Revelith Slides and, page by page, composites the main canvas's Konva layers into a PNG
...
<table><tr><td>reference<br><img src="${rel(r.ref)}"></td><td>Revelith Slides<br><img src="${rel(r.ours)}"></td><td>diff<br><img src="${rel(r.diff)}"></td></tr></table>`,
  )
  .join('')}
`
